...
state/               volatile runtime signals; gitignored
  ...
  .notify-speech-cache/  generated per-(class,voice,phrase) pre-rendered notification audio, keyed by checksum and TTL-pruned; see bin/fm-notify.sh; never touch
